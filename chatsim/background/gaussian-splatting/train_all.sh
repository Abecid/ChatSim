...
for SCENE_NAME in $(ls $DATA_DIR); do
    ...
    python train.py --config configs/chatsim/original.yaml source_path=~/workspace/adam/ChatSim/data/waymo_multi_view/${SCENE_NAME}/colmap/sparse_undistorted model_path=output/${SCENE_NAME} --wandb
